...
export const regions: optionsT = [
  {
    label: (
      <>
        <Globe className="size-3.5" /> US East
      </>
    ),
    value: 'us-east',
  ...
  },
  {
    label: (
      <>
        <Globe className="size-3.5" /> EU West
      </>
    ),
    value: 'eu-west',
  ...
  },
  {
    label: (
      <>
        <Globe className="size-3.5" /> AP Southeast
      </>
    ),
    value: 'ap-se',
...
export const memberMeta: Record<
  string,
  { initials: string; name: string; dept: string; bg: string }
> = {
...
export const memberOptions: optionsT = [
  {
    label: (
      <span className="flex items-center gap-2">
        <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-violet-500 text-[10px] font-bold text-white">
          AC
        </span>
        <span>
  ...
  },
  {
    label: (
      <span className="flex items-center gap-2">
        <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-sky-500 text-[10px] font-bold text-white">
          BK
        </span>
        <span>
  ...
  },
  {
    label: (
      <span className="flex items-center gap-2">
        <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-pink-500 text-[10px] font-bold text-white">
          CW
        </span>
        <span>
...
export const priorityOptions: optionsT = [
  {
    label: (
      <>
        <Flame className="size-3.5 text-red-500" /> Critical
      </>
    ),
    value: 'critical',
  },
  {
    label: (
      <>
        <ArrowUp className="size-3.5 text-orange-500" /> High
      </>
    ),
    value: 'high',
  },
  {
    label: (
      <>
        <Minus className="size-3.5 text-yellow-500" /> Medium
      </>
    ),
    value: 'medium',
  },
  {
    label: (
      <>
        <ArrowDown className="size-3.5 text-blue-500" /> Low
      </>
    ),
    value: 'low',
  },
...
export const priorityMeta: Record<string, { icon: ReactNode; cls: string }> = {
  critical: {
    icon: <Flame className="size-3 text-red-500" />,
    cls: 'text-red-600 dark:text-red-400',
  },
  high: {
    icon: <ArrowUp className="size-3 text-orange-500" />,
    cls: 'text-orange-600 dark:text-orange-400',
  },
  medium: {
    icon: <Minus className="size-3 text-yellow-500" />,
    cls: 'text-yellow-600 dark:text-yellow-400',
  },
  low: {
    icon: <ArrowDown className="size-3 text-blue-500" />,
