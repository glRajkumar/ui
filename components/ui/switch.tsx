  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full bg-background ring-0 transition-transform size-4.5 data-checked:translate-x-[calc(100%+1px)] dark:data-checked:bg-primary-foreground data-unchecked:translate-x-px dark:data-unchecked:bg-foreground"
      />
    </SwitchPrimitive.Root>
  )
}
