...
function CheckboxWrapper({ label, description, wrapperCls, className, ...props }: CheckboxWrapperProps) {
  return (
    <label className={cn('flex cursor-pointer select-none items-start gap-2 has-[:disabled]:cursor-not-allowed', wrapperCls)}>
      <Checkbox className={cn('mt-0.5', className)} {...props} />
