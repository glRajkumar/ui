...
**`isAllowedPrimitive`**: Type guard for runtime validation of primitive values

**`parseAllowedPrimitive`**: Intelligently parses string values back to their appropriate primitive types, enabling seamless type conversion in controlled components
