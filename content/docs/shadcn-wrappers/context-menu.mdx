---
title: Context Menu
description: A wrapper for Shadcn Context Menu — same options API as Dropdown, triggered by right-click on any element.
---
...
- [Dropdown Menu](/docs/shadcn-wrappers/dropdown-menu) — same options API, triggered by click
